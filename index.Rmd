---
title: |
  "Pacific Recreational Catch data revisions"
...
author_list: "Brown, N.E.M., Komick, N., Houtman, R., and Velez-Espino, A."
...
abstract: |
  The goal of this project is to increase the precision and accuracy of the coded-wire tag (CWT) estimate in recreational chinook fisheries in British Columbia. These estimates are derived from adipose clipped catch and submitted salmon heads to the voluntary Salmon Head Recovery Program. Recreational catch estimates were historically a combination of creel surveys (interviews and overflights) and logbook programs. However, there are substantial spatial and temporal gaps to both catch estimation and CWT collection. For example, remote areas provide challenges to implementing overflights and access to head depots. Furthermore, bad weather during winter months prevents overflights and therefore creel surveys tend to occur only during the busiest summer months. Finally, since fisher behaviour is regionally divided, voluntary programs may have differing success in different regions. All this variability leads to uncertainties in the CWT estimates. We aim to improve the Canadian CWT estimates by two main pathways: 1. Incorporating data from iREC survey to resolve spatial and temporal gaps in catch estimation, and 2. Grouping CWT regions and months to reduce uncertainty in CWT estimates.
french_abstract: |
