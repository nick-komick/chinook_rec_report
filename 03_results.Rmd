...
region_labels <- c(
  "CA JDF" = "Juan de Fuca",
  "CBC S" = "Central BC",
  "JNST S" = "Johnstone Strait",
  "NBC AABM" = "Northern BC AABM",
  "NBC ISBM" = "Nothern BC ISBM",
  "NGS S" = "Georgia Strait (North)",
  "NWCVI S" = "West Coast Vancouver Island (North)",
  "SGS S" = "Georgia Strait (South)",
  "SWCVI S" = "West Coast Vancouver Island (South)"
)
