...
Catch estimates are inputs to the exploitation rate analysis in two places. First, kept and marked catch estimates are used to expand Coded Wire Tag (CWT) observations from the SHRP to CWT estimates uploaded to RMIS. Canada updated CWT estimates based on revised catch and published them to RMIS in support of the 2025 ERA process.

- *What is the second part of this paragraph? (AV)*
