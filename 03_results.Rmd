...
#| fig-cap: "Revised (blue) and previously reported (green) legal-sized release catch estimates from 2005-2023. Revised estimates prior to vertical line in each graph are based on modelled data, whereas estimates after the vertical line are based on iREC and creel data."
