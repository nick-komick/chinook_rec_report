...
We found that catch estimates that included iREC data were broadly higher than previous estimates derived from only unfiltered creel and logbook information. As an example, Figure \@ref(fig:fig-jdf-catch-revised-1) shows the effect of the summed and revised 2013 to 2023 kept catch estimates for the Juan de Fuca fishery (dashed line) compared to the previous estimates without iREC inclusion (solid line). Though the relative difference between the two time series vary, the revised estimates are consistently higher than the estimates without iREC. Comparison plots for the remaining fisheries can be found in Appendix \ref{@third-appendix}.
