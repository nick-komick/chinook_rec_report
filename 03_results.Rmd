...
```{r results NBC AABM, results='asis', echo=FALSE}
#| label: fig-nbcaabm-model
#| fig-cap: "NBC AABM modelled results"
...
```{r results example NBC AABM, results='asis', echo=FALSE}
#| label: fig-nbcaabm-annual-model
#| fig-cap: "NBC AABM modelled results"
