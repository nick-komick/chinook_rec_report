...
The best model for Haida Gwaii fishery was one with a Gaussian distribution historic data (Haida creel + logbook, $C_{historic}$), status ($S$):
...
$$ C_{all,Z,S} = C_{historic,summer} + Z + S + Z:S   $$
