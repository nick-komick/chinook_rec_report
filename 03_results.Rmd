...
In the following section we present the results of revising Chinook catch using both the combined iREC, logbook, and creel results for more recent years and modelled estimates for pre-iREC years back to 2005. In addition to revising catch, the relationship between mark kept Chinook catch and CWT sampling through the SHRP is presented. This includes the sample rates across all regions and time series of CWT regions.  
