...
ggplot(data = head_catch_model_df, 
  ...
  ggtitle("Chinook Head to Marked Kept Catch") +
...
#| fig-cap: "Chinook heads to marked kept catch based on combined creel and iREC. Each point is a yearly CWT Region based on the seasonal or annual time periods in the southern or nothern portion of BC (i.e., NBC and CBC), respectively, from 2005 to 2012."
...
ggplot(data = pre_irec_catch_model_df,
  ...
  ggtitle("Before iREC Chinook Head to Marked Kept Catch") +
  xlab("Chinook Marked Kept Catch") + 
  ylab("Chinook Head Recoveries")+
  theme_bw()
...
#| fig-cap: "Chinook heads to marked kept catch based on combined creel and iREC.  Each point is a yearly CWT Region based on the seasonal or annual time periods in the southern or nothern portion of BC (i.e., NBC and CBC), respectively, from 2013 to 2023."
...
ggplot(data = post_irec_catch_model_df,
  ...
  ggtitle("iREC Chinook Head to Marked Kept Catch") +
  xlab("Chinook Marked Kept Catch") + 
  ylab("Chinook Head Recoveries")+
  theme_bw()
