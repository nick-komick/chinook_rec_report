...
iREC and creel both generally align spatially to Pacific Fisheries Management Area [@pfma_2007], with some areas split to support unique local conditions. However, there are a few areas that were initially not split by the iREC system into their component parts, as is done in creel estimates. Some of the splits, such PFMA 2 and 20 (which both are sometimes split into a east and west portion) were combined for this analysis.  While the PFMA 29 split into marine and tidal waters were ignored and treated as primarily marine catch.  For PFMA 19 and 23, we combined creel data from 2013 until the split was successfully incorporated into iREC with licence year 2014.
...
*These are the only notes I can think of with regard to the creel/iREC area alignment changes. *

*PFMA 19 and 23 have 2 very unique fishing areas with different fishing patterns.  (I’m not sure about the differences in PFMA 2 E/W)*
*19-GS is Saanich inlet which is mostly shell fishing and 19-JDF is the rest of 19 and is primarily salmon fishing area.*
*Area 23-ALB is Alberni Canal which tends to Sockeye fishing and 23-BARK which tends to target Chinook and Coho *

*Area 20 was split into 20W and 20E.  20W is accessed by the Port Renfrew survey and that is  usually limited  to May to September whereas the 20E portion is accessed from the Victoria area survey and that tends to include April to October or later in some months.  This results in some months only having an estimate for 20E and no estimate for 20W.*
...
As previously identified in this report, past recreational catch estimates had gaps in coverage that need to be revised and updated. Before this update to CWT estimation methods, there were regions and time periods that had no marked catch estimates or had inconsistencies between the number of recoveries and estimated marked catch (e.g. more samples than marked catch). To handle these issues, CWT estimates were based on several indirect methods. Indirect methods included using the average submission rate of the same region from other months (e.g. Strait of Georgia summer submission rates for winter months), the average submission rate from other regions (e.g. Southern BC submission rates for Central BC), or assumed maximum and minimum submission rates applied when estimated submission rates were unreasonably high or low, presumably resulting from uncertainty in the marked kept catch estimates.
