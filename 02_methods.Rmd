...
pfma_yearMonth_catch_estimate_1 <- 
  pfma_yearMonth  |>
  filter(sum_catch_estimate != sum, sum_catch_estimate != sum_historic, sum_catch_estimate != sum_irec)
...
g <-
  ggplot()+
  geom_tile(data=jdf_catch, aes(x=year, y=as.factor(month), fill = sum_catch_estimate),colour = "white") +
  ...
  new_scale_fill() +
  geom_tile(data=jdf_irec_catch, aes(x=year, y=as.factor(month), fill = sum_catch_estimate),colour = "white") +
