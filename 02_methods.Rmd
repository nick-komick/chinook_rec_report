...
We calculate mark rate in a number of different ways and prioritized the assignment of mark rate in the order identified below, based on availability.  Only mark rates that are based on a total catch estimate >= 10 are used:
