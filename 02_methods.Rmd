...
The iRec survey is designed to provide month recreational catch estimates for every area within DFO’s Pacific Region.   When the survey was initially designed, the survey used the legal definition of Pacific Fishery Management Areas (PFMA) within the PFMA 2007 act (???update with citation???).

### License Statification
