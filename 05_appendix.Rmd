...
for (i in 1:length(fishery_name_south)){
  graph_data <- 
    ...
    mutate(estimate_type = case_match(estimate_type,
...
#| fig-cap: "Validation plots for Strait of Georgia and Johnstone Strait Summer model"
...
prev_version_catch <-
  ...
  mutate(is_kept = grepl("kept", status, ignore.case = TRUE),
         ...
         finescale_fishery = if_else(grepl("NBC ISBM S", finescale_fishery),
                                     "NORTH ISBM S", 
                                     finescale_fishery),
         finescale_fishery = case_match(finescale_fishery,
                                        "CBC S" ~ "CENTRAL S",
                                        .default = finescale_fishery),
