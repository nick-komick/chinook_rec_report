...
```{r iRec Lic Select Prob Table, results='asis', echo=FALSE}
#| label: tab-irec-licence-selection-prob
#| fig-cap: "Probabilities of an annual licence being selected for a reporting month, based on the license purchase month after March 2020."
...
prev_version_catch <-
  ...
  mutate(is_kept = grepl("kept", status, ignore.case = TRUE),
         ...
         finescale_fishery = sub("NBC ISBM S", "NORTH ISBM S", finescale_fishery),
