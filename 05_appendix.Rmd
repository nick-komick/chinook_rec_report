...
prev_version_catch <-
  ...
  mutate(is_kept = grepl("kept", status, ignore.case = TRUE),
         ...
         finescale_fishery = case_when(finescale_fishery == "CBC S" ~ "CENTRAL S",
                                       finescale_fishery == "SWCVI S FALL AABM" ~ "SWCVI AABM S FALL",
                                       finescale_fishery == "SWCVI S SPRING AABM" ~ "SWCVI AABM S SPRING",
                                       finescale_fishery == "SWCVI S SUMMER AABM" ~ "SWCVI AABM S SUMMER",
                                       finescale_fishery == "NWCVI S FALL AABM" ~ "NWCVI AABM S FALL",
                                       finescale_fishery == "NWCVI S SPRING AABM" ~ "NWCVI AABM S SPRING",
                                       finescale_fishery == "NWCVI S SUMMER AABM" ~ "NWCVI AABM S SUMMER",
                                       finescale_fishery == "SWCVI S FALL ISBM" ~ "SWCVI ISBM S FALL",
                                       finescale_fishery == "SWCVI S SPRING ISBM" ~ "SWCVI ISBM S SPRING",
                                       finescale_fishery == "SWCVI S SUMMER ISBM" ~ "SWCVI ISBM S SUMMER",
                                       finescale_fishery == "NWCVI S FALL ISBM" ~ "NWCVI ISBM S FALL",
                                       finescale_fishery == "NWCVI S SPRING ISBM" ~ "NWCVI ISBM S SPRING",
                                       finescale_fishery == "NWCVI S SUMMER ISBM" ~ "NWCVI ISBM S SUMMER",
                                       grepl("NBC AABM S", finescale_fishery) ~ "NORTH AABM S",
