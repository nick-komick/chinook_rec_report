...
#| fig-cap: "Catch estimate differences between "
...
previous_model_catch <-
  ...
  full_join(select(all_north_aabm_full, year, status, summer_catch = catch_estimate_adj), 
            by = c("year", "status"))
